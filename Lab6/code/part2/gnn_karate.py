...
G = nx.read_weighted_edgelist('code_students/data/karate.edgelist', delimiter=' ', nodetype=int, create_using=nx.Graph())
...
class_labels = np.loadtxt('code_students/data/karate_labels.txt', delimiter=',', dtype=np.int32)
